	...
	$.slidebars = function(options) {
		...
		function open(side) {
			...
			if (side === 'left' && $left && rightActive || side === 'right' && $right && leftActive) { // It's open, close it, then continue.
				...
				// Added by laro to fix scroll
				$("html,body").addClass("no-scroll");
				//$("html,body").addClass("fullscreen-opacity");
				proceed();
			}
		...
		function close(link) {
			...
			//$("html,body").removeClass("fullscreen-opacity");
